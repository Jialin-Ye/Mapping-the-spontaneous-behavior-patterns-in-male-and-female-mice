...
Movement_Label_path_predict_night = get_path2(new_generate_data_night,'Movement_Labels.csv')
...
colors = ['#F5B25E', '#F5B25E', '#003960','#003960','#E6E243','#71BFCB']     # day-am & night-lightOFF
...
plt.xticks([])
plt.yticks([])
plt.savefig('{}/MOTP_MODP&NFTP_NFDP.png'.format(output_dir),dpi=300)
# Show the plot
plt.show()
