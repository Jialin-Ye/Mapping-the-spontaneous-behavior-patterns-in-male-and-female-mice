...
output_dir = r'F:\spontaneous_behavior\GitHub\Elaborate-spontaneous-activity-atlas-driven-behavior-patterns-in-both-sexes\Figure2_skeleton_kinematics\skeleton\original_40_movement_modules'
...
ske_data_list = []
for video_index in list(Light_on_info['video_index']):
...
#         df_frame_select = df_singleLocomotion
#     else:
#         df_frame_select = df_singleLocomotion.sample(n=1000, random_state=22) # weights='locomotion_speed_smooth',
#     df_select_list.append(df_frame_select)
# =============================================================================
...
def plot_TopView_skeleton(df_select):  ## related to Figure 2A
    ...
    for i in df_select['OriginalDigital_label'].unique():       
        ...
        face_color = 'white' #movement_color_dict[return_AnnoMovement(i)]
        ...
        fig = plt.figure(figsize=(5,5),constrained_layout=True,dpi=1200)
        ax = fig.add_subplot(1, 1, 1, projection='scatter_density')
        #ax.scatter(nose[0],nose[1],s=60,c='green',alpha = 0.8)
        ax.scatter(nose[0],nose[1],s=60,c='#9C27B0',marker='o',ec = 'black')
        ax.scatter(left_ear[0],left_ear[1],s=60,c='#B0BEC5',alpha = 0.8,ec = 'black')
        ax.scatter(right_ear[0],right_ear[1],s=60,c='#B0BEC5',alpha = 0.8,ec = 'black')
        
        ax.plot([nose[0],left_ear[0]],[nose[1],left_ear[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([nose[0],right_ear[0]],[nose[1],right_ear[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([left_ear[0],right_ear[0]],[left_ear[1],right_ear[1]],c='black',alpha = 0.8,lw=3)
        
        ax.scatter(neck[0],neck[1],s=60,c='#B0BEC5',alpha = 0.8,ec = 'black')
        ax.scatter(back[0],back[1],s=60,c='#B0BEC5',alpha = 0.8,ec = 'black')
        ax.scatter(root_tail[0],root_tail[1],s=60,c='#B0BEC5',alpha = 0.8,ec = 'black')
        ax.scatter(mid_tail[0],mid_tail[1],s=60,c='#B0BEC5',alpha = 0.8,ec = 'black')
        #ax.scatter(tip_tail[0],tip_tail[1],s=40,c='#607D5B',alpha = 0.8)
        
        ax.scatter(left_front_limb[0],left_front_limb[1],s=60,c='#B0BEC5',alpha = 0.8)
        ax.scatter(right_front_limb[0],right_front_limb[1],s=60,c='#B0BEC5',alpha = 0.8)
        ax.scatter(left_hind_limb[0],left_hind_limb[1],s=60,c='#B0BEC5',alpha = 0.8)
        ax.scatter(right_hind_limb[0],right_hind_limb[1],s=60,c='#B0BEC5',alpha = 0.8)
        
        ax.scatter(left_front_claw[0],left_front_claw[1],s=40,c='#FF1744',marker='^',ec = 'black',alpha = 0.8)
        ax.scatter(right_front_claw[0],right_front_claw[1],s=40,c='#F57C00',marker='^',ec = 'black',alpha = 0.8)
        ax.scatter(left_hind_claw[0],left_hind_claw[1],s=40,c='#FFFF00',marker='^',ec = 'black',alpha = 0.8)
        ax.scatter(right_hind_claw[0],right_hind_claw[1],s=40,c='#00E676',marker='^',ec = 'black',alpha = 0.8)
        
        ax.plot([left_front_limb[0],left_hind_limb[0]],[left_front_limb[1],left_hind_limb[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([left_hind_limb[0],right_hind_limb[0]],[left_hind_limb[1],right_hind_limb[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([right_hind_limb[0],right_front_limb[0]],[right_hind_limb[1],right_front_limb[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([right_front_limb[0],left_front_limb[0]],[right_front_limb[1],left_front_limb[1]],c='black',alpha = 0.8,lw=3)
        
        ax.plot([left_ear[0],neck[0]],[left_ear[1],neck[1]],c='black',alpha = 0.8,lw=2)
        ax.plot([right_ear[0],neck[0]],[right_ear[1],neck[1]],c='black',alpha = 0.8,lw=2)
        ax.plot([left_front_limb[0],neck[0]],[left_front_limb[1],neck[1]],c='black',alpha = 0.8,lw=2)
        ax.plot([right_front_limb[0],neck[0]],[right_front_limb[1],neck[1]],c='black',alpha = 0.8,lw=2)
        ax.plot([left_hind_limb[0],root_tail[0]],[left_hind_limb[1],root_tail[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([right_hind_limb[0],root_tail[0]],[right_hind_limb[1],root_tail[1]],c='black',alpha = 0.8,lw=3)
        
        ax.plot([root_tail[0],mid_tail[0]],[root_tail[1],mid_tail[1]],c='black',alpha = 0.8,lw=3)
        #ax.plot([mid_tail[0],tip_tail[0]],[mid_tail[1],tip_tail[1]],c='black',alpha = 0.8,lw=3)
        
    
        ax.plot([left_front_limb[0],back[0]],[left_front_limb[1],back[1]],c='black',alpha = 0.8,lw=2)
        ax.plot([right_front_limb[0],back[0]],[right_front_limb[1],back[1]],c='black',alpha = 0.8,lw=2)
        ax.plot([left_hind_limb[0],back[0]],[left_hind_limb[1],back[1]],c='black',alpha = 0.8,lw=2)
        ax.plot([right_hind_limb[0],back[0]],[right_hind_limb[1],back[1]],c='black',alpha = 0.8,lw=2)
        ...
        plt.axis('off')
        #if i == 40:
        plt.savefig('{}/{}_skeleton_topview.png'.format(output_dir,i),dpi=1200,transparent=True)
plot_TopView_skeleton(df_select)


def plot_2DsideView_skeleton(df_select):      ## related to Figure 2C
    #### sideview
    for i in df_select['OriginalDigital_label'].unique():
        df_singleLocomotion = df_select[df_select['OriginalDigital_label'] == i]
    #for i in df_select['revised_movement_label'].unique():
    #    df_singleLocomotion = df_select[df_select['revised_movement_label'] == i]
        ...
        ax = fig.add_subplot(1, 1, 1, projection='scatter_density')
        #ax.scatter(nose[0],nose[1],s=60,c='green',alpha = 0.8)
        ax.scatter(nose[0],nose[1],s=60,c='#9C27B0',marker='o',ec = 'black',zorder=2)
        ax.scatter(left_ear[0],left_ear[1],s=60,c='#B0BEC5',ec = 'black',alpha = 1,zorder=2)
        ax.scatter(right_ear[0],right_ear[1],s=60,c='#B0BEC5',ec = 'black',alpha = 1,zorder=2)
        ...
        ax.scatter(neck[0],neck[1],s=60,c='#03A9F4',ec = 'black',alpha = 1,zorder=2)
        ax.scatter(back[0],back[1],s=60,c='#66BB6A',ec = 'black',alpha = 1,zorder=2)
        ax.scatter(root_tail[0],root_tail[1],s=60,c='#009688',ec = 'black',alpha = 1,zorder=2)
        ax.scatter(mid_tail[0],mid_tail[1],s=60,c='#9E9D24',ec = 'black',alpha = 1,zorder=2)
        #ax.scatter(tip_tail[0],tip_tail[1],s=40,c='#607D5B',alpha = 0.8)
        
        ax.scatter(left_front_limb[0],left_front_limb[1],s=60,c='#B0BEC5',ec = 'black',alpha = 1,zorder=2)
        ax.scatter(right_front_limb[0],right_front_limb[1],s=60,c='#B0BEC5',ec = 'black',alpha = 1,zorder=2)
        ax.scatter(left_hind_limb[0],left_hind_limb[1],s=60,c='#B0BEC5',ec = 'black',alpha = 1,zorder=2)
        ax.scatter(right_hind_limb[0],right_hind_limb[1],s=60,c='#B0BEC5',ec = 'black',alpha = 1,zorder=2)
              
        
        ax.scatter(left_front_claw[0],left_front_claw[1],s=60,c='#FF1744',marker='^',ec = 'black',alpha =1,zorder=2)
        ax.scatter(right_front_claw[0],right_front_claw[1],s=60,c='#F57C00',marker='^',ec = 'black',alpha = 1,zorder=2)
        ax.scatter(left_hind_claw[0],left_hind_claw[1],s=60,c='#00E676',marker='^',ec = 'black',alpha = 1,zorder=3)
        ax.scatter(right_hind_claw[0],right_hind_claw[1],s=60,c='#FFFF00',marker='^',ec = 'black',alpha = 1,zorder=2)
        ...
        ax.plot([left_ear[0],neck[0]],[left_ear[1],neck[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([right_ear[0],neck[0]],[right_ear[1],neck[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([left_front_limb[0],neck[0]],[left_front_limb[1],neck[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([right_front_limb[0],neck[0]],[right_front_limb[1],neck[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([left_hind_limb[0],root_tail[0]],[left_hind_limb[1],root_tail[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([right_hind_limb[0],root_tail[0]],[right_hind_limb[1],root_tail[1]],c='black',alpha = 0.8,lw=3)
        ...
        ax.plot([left_front_limb[0],back[0]],[left_front_limb[1],back[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([right_front_limb[0],back[0]],[right_front_limb[1],back[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([left_hind_limb[0],back[0]],[left_hind_limb[1],back[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([right_hind_limb[0],back[0]],[right_hind_limb[1],back[1]],c='black',alpha = 0.8,lw=3)
        
        ax.plot([left_front_limb[0],left_front_claw[0]],[left_front_limb[1],left_front_claw[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([right_front_limb[0],right_front_claw[0]],[right_front_limb[1],right_front_claw[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([left_hind_limb[0],left_hind_claw[0]],[left_hind_limb[1],left_hind_claw[1]],c='black',alpha = 0.8,lw=3)
        ax.plot([right_hind_limb[0],right_hind_claw[0]],[right_hind_limb[1],right_hind_claw[1]],c='black',alpha = 0.8,lw=3)
        
        
        ax.plot([neck[0],nose[0]],[neck[1],nose[1]],c='#388E3C',alpha = 1,lw=4)
        ax.plot([neck[0],back[0]],[neck[1],back[1]],c='#388E3C',alpha = 1,lw=4)
        ax.plot([root_tail[0],back[0]],[root_tail[1],back[1]],c='#388E3C',alpha = 1,lw=4)
        ax.plot([root_tail[0],mid_tail[0]],[root_tail[1],mid_tail[1]],c='#388E3C',alpha = 0.8,lw=4)
        ...
        plt.savefig('{}/{}_skeleton_sideview.png'.format(output_dir,i),dpi=1200,transparent=True)
...
#### 3D###
    ...
    #for i in df_select['OriginalDigital_label'].unique():
        ...
        ax.scatter(nose[0],nose[1],nose[2],s=60,c='green',alpha = 0.3)
        ax.scatter(left_ear[0],left_ear[1],left_ear[2],s=60,c='green',alpha = 0.3)
        ax.scatter(right_ear[0],right_ear[1],right_ear[2],s=60,c='green',alpha = 0.3)
        ax.plot([nose[0],left_ear[0]],[nose[1],left_ear[1]],[nose[2],left_ear[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([nose[0],right_ear[0]],[nose[1],right_ear[1]],[nose[2],right_ear[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([left_ear[0],right_ear[0]],[left_ear[1],right_ear[1]],[left_ear[2],right_ear[2]],c='black',alpha = 0.3,lw=5)
        
        ax.scatter(neck[0],neck[1],neck[2],s=60,c='#607D5B',alpha = 0.3)
        ax.scatter(back[0],back[1],back[2],s=60,c='#607D5B',alpha = 0.3)
        ax.scatter(root_tail[0],root_tail[1],root_tail[2],s=60,c='#607D5B',alpha = 0.3)
        ax.scatter(mid_tail[0],mid_tail[1],mid_tail[2],s=60,c='#607D5B',alpha = 0.3)
        #ax.scatter(tip_tail[0],tip_tail[1],s=40,c='orange')
        
        ax.scatter(left_front_limb[0],left_front_limb[1],left_front_limb[2],s=60,c='blue',alpha = 0.3)
        ax.scatter(right_front_limb[0],right_front_limb[1],right_front_limb[2],s=60,c='blue',alpha = 0.3)
        ax.scatter(left_hind_limb[0],left_hind_limb[1],left_hind_limb[2],s=60,c='blue',alpha = 0.3)
        ax.scatter(right_hind_limb[0],right_hind_limb[1],right_hind_limb[2],s=60,c='blue',alpha = 0.3)
        
        ax.scatter(left_front_claw[0],left_front_claw[1],left_front_claw[2],s=250,c='#FF1744',marker='^',ec = 'black')
        ax.scatter(right_front_claw[0],right_front_claw[1],right_front_claw[2],s=250,c='#F57C00',marker='^',ec = 'black')
        ax.scatter(left_hind_claw[0],left_hind_claw[1],left_hind_claw[2],s=250,c='#00E676',marker='^',ec = 'black')
        ax.scatter(right_hind_claw[0],right_hind_claw[1],right_hind_claw[2],s=250,c='#00E5FF',marker='^',ec = 'black')
        
        ax.plot([left_front_limb[0],left_hind_limb[0]],[left_front_limb[1],left_hind_limb[1]],[left_front_limb[2],left_hind_limb[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([left_hind_limb[0],right_hind_limb[0]],[left_hind_limb[1],right_hind_limb[1]],[left_hind_limb[2],right_hind_limb[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([right_hind_limb[0],right_front_limb[0]],[right_hind_limb[1],right_front_limb[1]],[right_hind_limb[2],right_front_limb[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([right_front_limb[0],left_front_limb[0]],[right_front_limb[1],left_front_limb[1]],[right_front_limb[2],left_front_limb[2]],c='black',alpha = 0.3,lw=5)
        
        ax.plot([left_ear[0],neck[0]],[left_ear[1],neck[1]],[left_ear[2],neck[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([right_ear[0],neck[0]],[right_ear[1],neck[1]],[right_ear[2],neck[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([left_front_limb[0],neck[0]],[left_front_limb[1],neck[1]],[left_front_limb[2],neck[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([right_front_limb[0],neck[0]],[right_front_limb[1],neck[1]],[right_front_limb[2],neck[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([left_hind_limb[0],root_tail[0]],[left_hind_limb[1],root_tail[1]],[left_hind_limb[2],root_tail[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([right_hind_limb[0],root_tail[0]],[right_hind_limb[1],root_tail[1]],[right_hind_limb[2],root_tail[2]],c='black',alpha = 0.3,lw=5)
        
        ax.plot([root_tail[0],mid_tail[0]],[root_tail[1],mid_tail[1]],[root_tail[2],mid_tail[2]],c='black',alpha = 0.3,lw=5)
        #ax.plot([mid_tail[0],tip_tail[0]],[mid_tail[1],tip_tail[1]],c='black')
        
    
        ax.plot([left_front_limb[0],back[0]],[left_front_limb[1],back[1]],[left_front_limb[2],back[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([right_front_limb[0],back[0]],[right_front_limb[1],back[1]],[right_front_limb[2],back[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([left_hind_limb[0],back[0]],[left_hind_limb[1],back[1]],[left_hind_limb[2],back[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([right_hind_limb[0],back[0]],[right_hind_limb[1],back[1]],[right_hind_limb[2],back[2]],c='black',alpha = 0.3,lw=5)
        
        ax.plot([left_front_limb[0],left_front_claw[0]],[left_front_limb[1],left_front_claw[1]],[left_front_limb[2],left_front_claw[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([right_front_limb[0],right_front_claw[0]],[right_front_limb[1],right_front_claw[1]],[right_front_limb[2],right_front_claw[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([left_hind_limb[0],left_hind_claw[0]],[left_hind_limb[1],left_hind_claw[1]],[left_hind_limb[2],left_hind_claw[2]],c='black',alpha = 0.3,lw=5)
        ax.plot([right_hind_limb[0],right_hind_claw[0]],[right_hind_limb[1],right_hind_claw[1]],[right_hind_limb[2],right_hind_claw[2]],c='black',alpha = 0.3,lw=5)
...
def plot_BodyBendAngle_sideview(df_select):         ## related to Figure 2C
    ...
    for i in df_select['revised_movement_label'].unique():
        ...
        ax.set_ylim(-25,175)
        plt.axis('off')
        #plt.savefig('{}/{}_angle_sideview.png'.format(output_dir,i),dpi=600,transparent=True)
    df = pd.DataFrame(angle_info_dict)
    print(df)
        
#plot_BodyBendAngle_sideview(df_select)      




##### 计算身体弯曲程度
def plot_BodyBendAngle_topview(df_select):   ## related to Figure 2B
    angle_info_dict = {'movement_label':[],'nose-neck-back':[],'neck-back-tail':[],'back-tail1-tail2':[]}
    for i in df_select['revised_movement_label'].unique():
        df_singleLocomotion = df_select[df_select['revised_movement_label'] == i]
    #for i in df_select['OriginalDigital_label'].unique():       
    #    df_singleLocomotion = df_select[df_select['OriginalDigital_label'] == i]
        ...
        for j in df_singleLocomotion.index[0:-2]:
            ...
            if (i == 'left_turning') & (nose[0] < 20) & (nose[1]< 75):
                ...
                ax.scatter(neck[0],neck[1],s=60,c='#03A9F4',alpha = 0.1)
                ax.scatter(back[0],back[1],s=60,c='#66BB6A',alpha = 0.1)
                ax.scatter(root_tail[0],root_tail[1],s=60,c='#009688',alpha = 0.1)
                ax.scatter(mid_tail[0],mid_tail[1],s=60,c='#9E9D24',alpha = 0.1)
                ...
                ax.scatter(nose[0],nose[1],s=60,c='#9C27B0',alpha = 0.1)
                ax.scatter(neck[0],neck[1],s=60,c='#FDD835',alpha = 0.1)
        ...
        ax.set_ylim(-15,15)
        plt.axis('off')
        plt.savefig('{}/{}_skeleton_angle.png'.format(output_dir,i),dpi=600,transparent=True)
    df = pd.DataFrame(angle_info_dict)
    print(df)

#plot_BodyBendAngle_topview(df_select)
