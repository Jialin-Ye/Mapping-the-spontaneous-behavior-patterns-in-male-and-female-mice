...
skf = StratifiedKFold(n_splits=2,random_state=2020, shuffle=True)                                  ### use StratifiedKFold function to split traning and testing dataset
...
##################################### set female and male marker in the figure 
