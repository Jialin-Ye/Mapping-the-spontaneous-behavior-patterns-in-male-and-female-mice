...
setwd('F:/spontaneous_behavior/GitHub/Elaborate-spontaneous-activity-atlas-driven-behavior-patterns-in-both-sexes/sFigure10-11_Movement_spatiotemporal_pattern/Mov_time_loc_data')
Movement_csv_data <- read.csv('Night_lightOn_singleMice_Mov.csv')
movement_label <- Movement_csv_data

Location_time_Movement_csv_data <- read.csv('Night_lightOn_Temporal_locMoc.csv')
...
ggsave('F:/spontaneous_behavior/GitHub/Elaborate-spontaneous-activity-atlas-driven-behavior-patterns-in-both-sexes/sFigure10-11_Movement_spatiotemporal_pattern/Output_figure/Night_lightOn_lightOn.png',dpi=600)